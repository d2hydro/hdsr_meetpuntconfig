...
from fews_utilities import FewsConfig
...
from utils import get_validation_attribs
from utils import idmap2tags
from utils import sort_validation_attribs
from utils import update_date
from utils import update_histtag
from utils import update_hlocs
...
class MeetpuntConfig:
    ...
    def check_expar_errors_intloc_missing(
        ...
        for int_loc, loc_group in idmap_df.groupby("internalLocation"):
            ...
            ex_pars_gen = [re.sub(r"\d", "meetpuntconfig", ex_par) for ex_par in ex_pars]
